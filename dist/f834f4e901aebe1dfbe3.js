function checkValidProviderEndpoint(e, n) {
    var t = big_api_map[e.toLowerCase()];
    if (!t) return [{}, "", "Invalid provider"];
    var r = t[n];
    return r ? [r, t.base_url, ""] : [{}, "", "Invalid endpoint"]
}

for (var string = "string", number = "number", big_api_map = {
    coinbase: {
        ...
        "Get exchange rates": {
            ...
            params: {currency: {default: "USD", type: "string", description: "Base currency"}},
            go_down_1_level: !0,
        ...
        "Get buy price": {
            ...
            params: {currency_pair: {required: !0, replace_2dots: !0, type: "string"}},
            go_down_1_level: !0,
            sample_response: '{\n  "data": {\n    "amount": "1020.25",\n    "currency": "USD"\n  }\n}'
        },
        "Get sell price": {
        ...
        "Get spot price": {
            ...
            params: {
                currency_pair: {required: !0, replace_2dots: !0, type: "string"},
                date: {type: "string", description: "Specify date for historic spot price in format YYYY-MM-DD (UTC)"}
            },
            go_down_1_level: !0,
            sample_response: '{\n  "data": {\n    "amount": "1010.25",\n    "currency": "USD"\n  }\n}'
        },
        ...
        "Order Book": {
            ...
            transformOutput: function (e) {
                return e[0][0] = "askPrice", e[0][1] = "askQuantity", e[0][2] = "bidsPrice", e[0][3] = "bidsQuantity", e
            }
        },
        "Recent Trades List": {
            url: "/api/v3/trades",
        ...
        "Aggregate Trades List": {
            ...
            transformOutput: function (e) {
                return e[0][0] = "isBestMatch", e[0][1] = "timestamp", e[0][2] = "aggregateTradeId", e[0][3] = "firstTradeId", e[0][4] = "lastTradeId", e[0][5] = "isBuyerMaker", e[0][6] = "price", e[0][7] = "quantity", e
            },
        ...
        "Candlestick Data": {
            ...
            params: {
                symbol: {required: !0, type: "string"},
                interval: {required: !0, type: "enum", possible: ["1m", "5m", "15m", "30m", "1h", "1d", "1w", "1M"]},
                startTime: {type: "number"},
                endTime: {type: "number"},
                limit: {type: "number", description: "Default 500; max 1000.", default: 500}
            },
            transformOutput: function (e) {
                return e[0][0] = "openTime", e[0][1] = "open", e[0][2] = "high", e[0][3] = "low", e[0][4] = "close", e[0][5] = "volume", e[0][6] = "closeTime", e[0][7] = "quoteAssetVolume", e[0][8] = "numberOfTrades", e[0][9] = "baseAssetVolume", e[0][10] = "quoteAssetVolume", e[0][11] = "ignore", e
            },
        ...
        "Current Average Price": {
            url: "/api/v3/avgPrice",
            params: {symbol: {required: !0, type: "string"}},
        ...
        "Get Asset Info": {
            ...
            params: {
                asset: {
                    type: "string",
                    description: "Comma delimited list of assets to get info on (e.g. asset=XBT,ETH)."
                }
            },
        ...
        "Get Ticker Information": {
            ...
            params: {
                pair: {
                    required: !0,
                    description: "Asset pair to get data for (e.g. pair=XBTUSD)",
                    type: "string"
                }
            },
            go_down_1_level: !0,
        ...
        "Get OHLC Data": {
            url: "/public/OHLC",
            params: {
                pair: {required: !0, type: "string", description: "Asset pair to get data for (e.g. pair=XBTUSD)"},
                interval: {
                    type: "enum",
                    description: "Time frame interval in minutes",
                    possible: [1, 5, 15, 30, 60, 240, 1440, 10080, 21600]
                },
                since: {
                    type: "number",
                    description: "Return committed OHLC data since given ID (e.g. since=1548111600)"
                }
            },
            go_down_1_level: !0,
            transformOutput: function (e) {
                for (var n = ["time", "open", "high", "low", "close", "vwap", "volume", "count"], t = 0; t < n.length; t++) e[0][t] = e[0][t].split("[")[0] + "_" + n[t];
                return e
            },
        ...
        "Get Order Book": {
            ...
            params: {
                ...
                count: {
                    type: "number",
                    description: "maximum number of asks/bids. Can take value between 1 and 500",
                    default: 100
                }
            },
            go_down_1_level: !0,
        ...
        "Get Recent Trades": {
            ...
            go_down_1_level: !0,
            transformOutput: function (e) {
                for (var n = ["price", "volume", "time", "buy/sell", "limit", "miscellaneous"], t = 0; t < n.length; t++) e[0][t] = e[0][t].split("[")[0] + "_" + n[t];
                return e
            },
        ...
        "Get Recent Spreads": {
            ...
            go_down_1_level: !0,
            transformOutput: function (e) {
                for (var n = ["time", "bid", "ask"], t = 0; t < n.length; t++) e[0][t] = e[0][t].split("[")[0] + "_" + n[t];
                return e
            },
        ...
        "Return Ticker": {
            url: "",
            go_up_1_level: !0,
            params: {command: {default: "returnTicker", append_to_url: !0}},
        ...
        "Return 24h Volume": {
            url: "",
            params: {command: {default: "return24hVolume", append_to_url: !0}},
            specialHandleFunction: function (e) {
                for (var n = [["", "First currency's volume", "Second currency's volume"]], t = 0, r = Object.keys(e); t < r.length; t++) {
                    var i = r[t];
                    if (i.includes("total")) n.push([i, e[i], ""]); else {
                        for (var s = [i], a = 0, o = Object.keys(e[i]); a < o.length; a++) {
                            var l = o[a];
                            s.push(e[i][l])
                        }
                        n.push(s)
        ...
        "Return Order Book": {
            ...
            params: {
                currencyPair: {
                    type: "string",
                    description: 'A string that defines the market, "USDT_BTC" for example. Use "all" for all markets.'
                },
                depth: {type: "number", default: 50, description: "Default depth is 50. Max depth is 100"},
                command: {default: "returnOrderBook", append_to_url: !0}
            },
        ...
        "Return Chart Data": {
            ...
            params: {
                currencyPair: {
                    required: !0,
                    type: "string",
                    description: 'A string that defines the market, "USDT_BTC" for example'
                },
                start: {required: !0, type: "number", description: "UNIX timestamp"},
                end: {required: !0, type: "number", description: "UNIX timestamp"},
                period: {
                    required: !0,
                    type: "number",
                    description: "Candlestick period in seconds. Valid values are 300, 900, 1800, 7200, 14400, and 86400."
                },
                command: {default: "returnChartData", append_to_url: !0}
            },
        ...
        "Return Currencies": {
            ...
            params: {
                includeMultiChainCurrencies: {
                    ...
                    type: "enum",
                    possible: ["true", "false"],
                    description: "A boolean that indicates if multi chain currencies are included (default value is false)"
                }, command: {default: "returnCurrencies", append_to_url: !0}
            },
            go_up_1_level: !0,
        ...
        "Return Loan Order": {
            url: "",
            params: {
                currency: {required: !0, type: "string", description: "currency (e.g. BTC)"},
                command: {default: "returnLoanOrders", append_to_url: !0}
            },
        ...
        "Get Symbols List": {
            url: "/api/v1/symbols",
            params: {market: {type: "string", description: "The trading market"}},
            go_down_1_level: !0,
        ...
        "Get 24hr Stats": {
            ...
            params: {symbol: {required: !0, type: "string", description: "symbol (e.g. BTC-USDT)"}},
            go_down_1_level: !0,
        ...
        "Get Aggregated Order Book": {
            ...
            go_down_1_level: !0,
            transformOutput: function (e) {
                return e[0][0] = "askPrice", e[0][1] = "askSize", e[0][2] = "bidsPrice", e[0][3] = "bidsSize", e
            },
        ...
        "Get Candlesticks": {
            ...
            params: {
                symbol: {required: !0, type: "string", description: "symbol (e.g. BTC-USDT)"},
                type: {
                    required: !0,
                    type: "enum",
                ...
                startAt: {required: !0, type: "number", description: "UNIX timestamp"},
                endAt: {required: !0, type: "number", description: "UNIX timestamp"}
            },
            go_down_1_level: !0,
            transformOutput: function (e) {
                for (var n = ["time", "open", "close", "high", "low", "volume", "amount"], t = 0; t < n.length; t++) e[0][t] = n[t];
                return e
            },
        ...
        "Get Currency Detail": {
            ...
            params: {
                currency: {required: !0, replace_2dots: !0, type: "string", description: "currency (e.g. BTC)"},
                chain: {
                    type: "string",
                    description: "Support for querying the chain of currency, return the currency details of all chains by default."
                }
            },
            go_down_1_level: !0,
        ...
        "Get Fiat Price": {
            ...
            params: {
                base: {
                    type: "string",
                    default: "USD",
                    description: "Ticker symbol of a base currency,eg.USD,EUR. Default is USD"
                },
                currencies: {
                    type: "string",
                    description: "Comma-separated cryptocurrencies to be converted into fiat, e.g. BTC,ETH, etc. Default to return the fiat price of all currencies."
                }
            },
            go_down_1_level: !0,
            go_up_1_level: !0,
        ...
        "Get Mark Price": {
            ...
            params: {symbol: {required: !0, replace_2dots: !0, type: "string", description: "symbol (e.g. USDT-BTC)"}},
            go_down_1_level: !0,
        ...
        Candlesticks: {
            ...
            params: {
                ...
                time_frame: {
                    ...
                    type: "enum",
                    possible: ["1m", "5m", "15m", "30m", "1hr", "6hr", "1day"]
                }
            },
            transformOutput: function (e) {
                for (var n = ["time", "open", "high", "low", "close", "volume"], t = 0; t < n.length; t++) e[0][t] = n[t];
                return e
            },
        ...
        "Trade History": {
            ...
            params: {
                ...
                timestamp: {
                    type: "number",
                    description: "Only return trades after this timestamp. If not present, will show the most recent trades"
                },
                limit_trades: {
                    type: "number",
                    default: 50,
                ...
                include_breaks: {
                    ...
                    default: "false",
                    possible: ["true", "false"],
                    description: "Whether to display broken trades"
                }
            },
        ...
        "Auction History": {
            ...
            params: {
                ...
                since: {
                    type: "number",
                    description: "Only returns auction events after the specified UNIX timestamp. If not present or empty, will show the most recent auction events"
                },
                limit_auction_results: {
                    type: "number",
                    description: "The maximum number of auction events to return. The default is 50.",
                    default: 50
                },
                include_indicative: {
                    type: "enum",
                    possible: ["true", "false"],
                    description: "Whether to include publication of indicative prices and quantities. Choose true to explicitly enable, and false to disable.",
                    default: "true"
                }
            },
        ...
        "Get Tickers": {
            ...
            params: {
                instType: {
                    required: !0,
                    type: "enum",
                    possible: ["SPOT", "SWAP", "FUTURE", "OPTION"],
        ...
        "Get Ticker": {
            ...
            params: {instId: {required: !0, type: "string", description: "Instrument ID, e.g. BTC-USD-SWAP"}},
            go_down_1_level: !0,
        ...
        "Get Index Tickers": {
            ...
            params: {
                quoteCcy: {
                    type: "string",
                    description: "Quote currency. Currently there is only an index with USD/USDT/BTC as the quote currency."
                },
        ...
        "Get Order Book": {
            ...
            params: {
                instId: {required: !0, type: "string", description: "Instrument ID, e.g. BTC-USDT"},
                sz: {
                    default: 1,
                    type: "string",
                    description: "Order book depth per side. Maximum 400, e.g. 400 bids + 400 asks. Default returns to 1 depth data"
                }
            },
            go_down_1_level: !0,
        ...
        "Get Candlesticks": {
            ...
            params: {
                instId: {required: !0, type: "string", description: "Instrument ID, e.g. BTC-USD-200927"},
                bar: {
                    type: "string",
                    default: "1m",
                ...
                after: {
                    type: "string",
                    description: "Pagination of data to return records earlier than the requested timestamp"
                },
                before: {
                    type: "string",
                    description: "Pagination of data to return records newer than the requested timestamp"
                },
                limit: {
                    type: "number",
            ...
            go_down_1_level: !0,
            transformOutput: function (e) {
                return e[0][0] = "timestamp", e[0][1] = "open", e[0][2] = "high", e[0][3] = "low", e[0][4] = "close", e[0][5] = "volume", e[0][6] = "volumeCcy", e
            },
        ...
        "Get Index Candlesticks": {
            ...
            params: {
                instId: {required: !0, type: "string", description: "Index, e.g. BTC-USD-200927"},
                bar: {
                    type: "string",
                    default: "1m",
                    description: "Bar size, the default is 1m\ne.g. [1m/3m/5m/15m/30m/1H/2H/4H]\nHong Kong time opening price k-line：[6H/12H/1D/1W/1M/3M/6M/1Y]\nUTC time opening price k-line：[/6Hutc/12Hutc/1Dutc/1Wutc/1Mutc/3Mutc/6Mutc/1Yutc]"
            ...
            go_down_1_level: !0,
            transformOutput: function (e) {
                return e[0][0] = "timestamp", e[0][1] = "open", e[0][2] = "high", e[0][3] = "low", e[0][4] = "close", e
            },
        ...
        "Get Mark Price Candlesticks": {
            ...
            params: {
                instId: {required: !0, type: "string", description: "Instrument ID, e.g. BTC-USD-SWAP"},
                bar: {
                    type: "string",
                    default: "1m",
                    description: "Bar size, the default is 1m\ne.g. [1m/3m/5m/15m/30m/1H/2H/4H]\nHong Kong time opening price k-line：[6H/12H/1D/1W/1M/3M/6M/1Y]\nUTC time opening price k-line：[/6Hutc/12Hutc/1Dutc/1Wutc/1Mutc/3Mutc/6Mutc/1Yutc]"
        ...
        "Get Index Components": {
            ...
            params: {index: {required: !0, type: "string", description: "index, e.g BTC-USDT"}},
            go_down_1_level: !0,
        ...
        "Get Open Interest": {
            ...
            params: {
                instType: {
                    required: !0,
                    type: "enum",
                    possible: ["SWAP", "FUTURE", "OPTION"],
                    description: "Instrument type"
                },
                uly: {
                    type: "string",
                    description: "Underlying. Only applicable to FUTURES/OPTION/SWAP. Required for OPTION"
                },
                instId: {
                    type: "string",
                    description: "Instrument ID, e.g. BTC-USD-180216. Only applicable to FUTURES/SWAP/OPTION"
                }
            },
            go_down_1_level: !0,
        ...
        "Get Limit Price": {
            ...
            params: {
                instId: {
                    required: !0,
                    type: "string",
                    description: "Instrument ID, e.g. BTC-USD-SWAP. Only applicable to FUTURES/SWAP/OPTION"
                }
            },
            go_down_1_level: !0,
        ...
        "Get Option Market Data": {
            ...
            params: {
                uly: {type: "string", description: "Underlying. Only applicable to OPTION", required: !0},
        ...
        "Get Estimated Delivery Price": {
            ...
            params: {
                instId: {
                    required: !0,
                    type: "string",
                    description: "Instrument ID, e.g. BTC-USD-200214, only applicable to FUTURES/OPTION"
                }
            },
            go_down_1_level: !0,
        ...
        "Get Liquidation Orders": {
            ...
            params: {
                instType: {
                    required: !0,
                    type: "enum",
                    possible: ["SWAP", "OPTION", "FUTURES", "MARGIN"],
                    description: "Instrument type"
                },
                ...
                alias: {
                    type: "enum",
                    possible: ["this_week", "next_week", "quarter", "next_quarter"],
                    description: "required for FUTURE"
                },
                state: {
                    type: "enum",
                    possible: ["filled", "unfilled"],
                    description: "required for FUTURE/SWAP",
                    default: "unfilled"
                },
                before: {
                    type: "number",
        ...
        "Get Position Tiers": {
            ...
            params: {
                ...
                tdMode: {required: !0, type: "enum", description: "Trade mode", possible: ["cross", "isolated"]},
                instId: {type: "string", description: "Instrument ID, e.g. BTC-USDT, only applicable to MARGIN"},
                uly: {type: "string", description: "Underlying", required: !0},
        ...
        "Get Taker Volume": {
            ...
            params: {
                instType: {
                    required: !0,
                    type: "enum",
                    possible: ["SPOT", "CONTRACTs"],
                    description: "Instrument type"
                },
                ccy: {required: !0, description: "currency", type: "string"},
            ...
            go_down_1_level: !0,
            transformOutput: function (e) {
                return e[0][0] = "timestamp", e[0][1] = "sellVol", e[0][2] = "buyVol", e
            },
        ...
        "Get Margin Lending Ratio": {
            ...
            go_down_1_level: !0,
            transformOutput: function (e) {
                return e[0][0] = "timestamp", e[0][1] = "ratio", e
            },
        ...
        "Get Contracts Open Interest and Volume": {
            ...
            transformOutput: function (e) {
                return e[0][0] = "timestamp", e[0][1] = "openInterest", e[0][2] = "vol", e
            },
        ...
        "Get Options Open Interest and Volume": {
            ...
            params: {
                ...
                period: {
                    ...
                    possible: ["8H", "1D"],
                    default: "8H",
                    description: "Each granularity can only query 72 pieces of data at the earliest"
                }
            },
            go_down_1_level: !0,
            transformOutput: function (e) {
        ...
        "Get Put or Call Ratio": {
            ...
            go_down_1_level: !0,
            transformOutput: function (e) {
                return e[0][0] = "timestamp", e[0][1] = "openInterestRatio", e[0][2] = "volRatio", e
            },
        ...
        "Get Open Interest and Volume (Expiry)": {
            ...
            go_down_1_level: !0,
            transformOutput: function (e) {
                return e[0][0] = "timestamp", e[0][1] = "expiryDate", e[0][2] = "callOpenInterest", e[0][3] = "putOpenInterest", e[0][4] = "callVol", e[0][5] = "putVolume", e
            },
        ...
        "Get Open Interest and Volume (Strike)": {
            ...
            transformOutput: function (e) {
                return e[0][0] = "timestamp", e[0][1] = "strike", e[0][2] = "callOpenInterest", e[0][3] = "putOpenInterest", e[0][4] = "callVol", e[0][5] = "putVolume", e
            },
        ...
        "Get Taker Flow": {
            ...
            go_down_1_level: !0,
            transformOutput: function (e) {
                var n = Array.from({length: 7}, (function () {
                    return Array.from({length: 2}, (function () {
                        return ""
                    }))
                }));
                return e = e.slice(1, e.length), n[0][0] = "timestamp", n[0][1] = e[0][0], n[1][0] = "callBuyVol", n[1][1] = e[1][0], n[2][0] = "callSellVol", n[2][1] = e[2][0], n[3][0] = "putBuyVol", n[3][1] = e[3][0], n[4][0] = "putSellVol", n[4][1] = e[4][0], n[5][0] = "callBlockVol", n[5][1] = e[5][0], n[6][0] = "putBlockVol", n[6][1] = e[6][0], n
            },
        ...
        "Get Currencies": {
            ...
            params: {currencies: {type: "string", description: "comma-separated list of currencies "}},
        ...
        "Get Symbols": {
            ...
            params: {symbols: {type: "string", description: "Comma-separated list of symbol codes."}},
            go_up_1_level: !0,
        ...
        "Get Prices": {
            ...
            params: {
                from: {required: !0, type: "string", description: "Source currency code."},
                to: {required: !0, type: "string", description: "Target currency code."}
            },
            go_up_1_level: !0,
        ...
        "Get Prices History": {
            ...
            params: {
                ...
                period: {
                    type: "enum",
                    description: "Default is M30 (30 minutes).",
                    possible: ["M1", "M3", "M5", "M15", "M30", "H1", "H4", "D1", "D7", "1M"],
                    default: "M30"
                }
            },
            go_up_1_level: !0,
        ...
        "Get Order Books": {
            ...
            params: {
                ...
                depth: {
                    type: "number",
                    default: 100,
                    description: "Order Book depth. Default value: 100. Set to 0 to view the full Order Book"
                }
            },
            go_up_1_level: !0,
            transformOutput: function (e) {
                if (e.length < 1) return e;
                for (var n = 0; n < e[0].length; n++) e[0][n].length > 3 && ("[0]" === e[0][n].slice(e[0][n].length - 3, e[0][n].length) ? e[0][n] = e[0][n].slice(0, e[0][n].length - 3) + "Price" : "[1]" === e[0][n].slice(e[0][n].length - 3, e[0][n].length) && (e[0][n] = e[0][n].slice(0, e[0][n].length - 3) + "Amount"));
                return e
            },
        ...
        "Get Funding History": {
            ...
            params: {
                offset: {
                    type: "number",
                    description: "Default value: 10. Accepted values: 0 – 100000",
                    default: 0
                },
                symbols: {type: "string", description: "Comma-separated list of symbol codes."},
                sort: {type: "enum", description: "Sort direction.", possible: ["DESC", "ASC"], default: "DESC"},
        ...
        "Get Tickers": {
            url: "/v2/tickers",
            params: {symbols: {required: !0, type: "string", description: "comma-separated list of symbols"}},
            transformOutput: function (e) {
                if (e.length < 1) return e;
                var n;
                n = 11 === e[0].length ? ["SYMBOL", "BID", "BID_SIZE", "ASK", "ASK_SIZE", "DAILY_CHANGE", "DAILY_CHANGE_RELATIVE", "LAST_PRICE", "VOLUME", "HIGH", "LOW"] : ["SYMBOL", "FRR", "BID", "BID_PERIOD", "BID_SIZE", "ASK", "ASK_PERIOD", "ASK_SIZE", "DAILY_CHANGE", "DAILY_CHANGE_RELATIVE", "LAST_PRICE", "VOLUME", "HIGH", "LOW", "_PLACEHOLDER", "_PLACEHOLDER", "FRR_AMOUNT_AVAILABLE"];
                for (var t = 0; t < e[0].length; t++) e[0][t] = n[t];
                return e
            },
        ...
        "Get Tickers History": {
            url: "/v2/tickers/hist",
            params: {
                symbols: {required: !0, type: "string", description: "comma-separated list of symbols"},
            ...
            transformOutput: function (e) {
                if (e.length < 1) return e;
                for (var n = ["SYMBOL", "BID", "PLACEHOLDER", "ASK", "PLACEHOLDER", "PLACEHOLDER", "PLACEHOLDER", "PLACEHOLDER", "PLACEHOLDER", "PLACEHOLDER", "PLACEHOLDER", "PLACEHOLDER", "TIMESTAMP"], t = 0; t < e[0].length; t++) e[0][t] = n[t];
                return e
            },
        ...
        "Get Trades": {
            ...
            params: {
                symbol: {
                    ...
                    replace_2dots: !0,
                    type: "string",
                    description: "The symbol you want information about. (e.g. tBTCUSD, tETHUSD, fUSD, fBTC)"
                },
                start: {type: "number", description: "Millisecond start time"},
                end: {type: "number", description: "Millisecond end time"},
            ...
            transformOutput: function (e) {
                if (e.length < 1) return e;
                var n;
                n = 4 === e[0].length ? ["ID", "TIMESTAMP", "AMOUNT", "PRICE"] : ["ID", "TIMESTAMP", "AMOUNT", "RATE", "PERIOD"];
                for (var t = 0; t < e[0].length; t++) e[0][t] = n[t];
                return e
            },
        ...
        "Get Order Book": {
            ...
            transformOutput: function (e) {
                if (e.length < 1) return e;
                var n;
                n = 3 === e[0].length ? ["ORDER_ID", "PRICE", "AMOUNT"] : ["ORDER_ID", "PERIOD", "RATE", "AMOUNT"];
                for (var t = 0; t < e[0].length; t++) e[0][t] = n[t];
                return e
            },
        ...
        "Get Stats": {
            ...
            params: {
                key: {
                    required: !0,
                    replace_2dots: !0,
                    possible: ["funding.size", "credits.size", "credits.size.sym", "pos.size", "vol.1d", "vol.7d", "vol.30d", "vwap"]
                },
                size: {
                    required: !0,
                    description: 'Available values: "1m" (for keys: "pos.size", "funding.size", "credits.size", "credits.size.sym"), "30m" (for keys: vol.1d, vol.7d, vol.30d), "1d" (for keys: vwap)',
                    replace_2dots: !0,
                    possible: ["1m", "30m", "1d"]
                },
                symbol: {
                    ...
                    type: string,
                    replace_2dots: !0,
                    description: 'The symbol you want information about. (e.g. tBTCUSD, tETHUSD, fUSD, fBTC) (used for keys: "pos.size", "funding.size", "credits.size", "credits.size.sym", "vwap")'
                },
                side: {
                    required: !0,
                    possible: ["long", "short"],
                    replace_2dots: !0,
                    description: 'Only used for "pos.size" key. Available values: "long", "short". Only for non-funding queries.'
                },
                section: {
                    required: !0,
                    description: 'Available values: "last", "hist"',
                    replace_2dots: !0,
                    possible: ["last", "hist"]
                },
                start: {type: "number", description: "Millisecond start time"},
            ...
            transformOutput: function (e) {
                if (e.length < 1) return e;
                for (var n = ["TIMESTAMP", "VALUE"], t = 0; t < e[0].length; t++) e[0][t] = n[t];
                return e
            },
        ...
        "Get Candlesticks": {
            ...
            params: {
                ...
                timeframe: {
                    required: !0,
                    description: "Available values: '1m', '5m', '15m', '30m', '1h', '3h', '6h', '12h', '1D', '1W', '14D', '1M'",
                    replace_2dots: !0,
                    possible: ["1m", "5m", "15m", "30m", "1h", "3h", "6h", "12h", "1D", "1W", "14D", "1M"]
                },
                section: {
                    required: !0,
                    description: 'Available values: "last", "hist"',
            ...
            transformOutput: function (e) {
                if (e.length < 1) return e;
                for (var n = ["TIMESTAMP", "OPEN", "CLOSE", "HIGH", "LOW", "VOLUME"], t = 0; t < e[0].length; t++) e[0][t] = n[t];
                return e
            },
        ...
        "Get Derivatives Status": {
            ...
            params: {
                keys: {
                    required: !0,
                    type: string,
                    description: "The key or keys (Separate by commas) of the pairs to fetch status information. To fetch information for all pairs use the key value 'ALL'"
                }
            },
            transformOutput: function (e) {
                if (e.length < 1) return e;
                for (var n = ["KEY", "TIMESTAMP", "PLACEHOLDER", "DERIV_PRICE", "SPOT_PRICE", "PLACEHOLDER", "INSURANCE_FUND_BALANCE", "PLACEHOLDER", "NEXT_FUNDING_EVT_TIMESTAMP_MS", "NEXT_FUNDING_ACCRUED", "NEXT_FUNDING_STEP", "PLACEHOLDER", "CURRENT_FUNDING", "PLACEHOLDER", "PLACEHOLDER", "MARK_PRICE", "PLACEHOLDER", "PLACEHOLDER", "OPEN_INTEREST", "PLACEHOLDER", "PLACEHOLDER", "PLACEHOLDER", "CLAMP_MIN", "CLAMP_MAX"], t = 0; t < e[0].length; t++) e[0][t] = n[t];
                return e
            },
        ...
        "Get Derivatives Status History": {
            ...
            params: {
                symbol: {
                    required: !0,
                    replace_2dots: !0,
                    description: "The symbol you want information about. (e.g. tBTCF0:USTF0, tETHF0:USTF0, etc.)",
                    type: string
                },
                start: {type: "number", description: "Millisecond start time"},
                end: {type: "number", description: "Millisecond end time"},
        ...
        "Get Liquidations": {
            ...
            transformOutput: function (e) {
                if (e.length < 1) return e;
                for (var n = ["pos", "POS_ID", "TIMESTAMP", "PLACEHOLDER", "SYMBOL", "AMOUNT", "BASE_PRICE", "PLACEHOLDER", "IS_MATCH", "IS_MARKET_SOLD", "PLACEHOLDER", "PRICE_ACQUIRED"], t = 0; t < e[0].length; t++) e[0][t] = n[t];
                return e
            },
        ...
        "Get Leaderboards": {
            ...
            params: {
                key: {
                    required: !0,
                    description: 'Allowed values: "plu_diff" for unrealized profit (period delta); "plu" for unrealized profit (inception); "vol" for volume; "plr" for realized profit',
                    replace_2dots: !0,
                    possible: ["plu_diff", "plu", "vol", "plr"]
                },
                timeframe: {required: !0, possible: ["3h", "1w", "1M"], replace_2dots: !0},
                symbol: {
                    required: !0,
                    replace_2dots: !0,
                    type: string,
                    description: "The symbol you want information about. (e.g. tBTCUSD, tETHUSD, tGLOBAL:USD) - see table below for available symbols per key"
                },
                start: {type: "number", description: "Millisecond start time"},
                end: {type: "number", description: "Millisecond end time"},
                limit: {type: "number", description: "Number of records (Max: 10000)", default: 125},
            ...
            transformOutput: function (e) {
                if (e.length < 1) return e;
                for (var n = ["TIMESTAMP", "PLACEHOLDER", "USERNAME", "RANKING", "PLACEHOLDER", "PLACEHOLDER", "VALUE", "PLACEHOLDER", "PLACEHOLDER", "TWITTER_HANDLE"], t = 0; t < e[0].length; t++) e[0][t] = n[t];
                return e
            },
        ...
        "Get Pulse Profile Details": {
            ...
            params: {
                nickname: {
                    ...
                    replace_2dots: !0,
                    type: string,
                    description: "Enter pulse user nickname (case sensitive)"
                }
            },
        ...
        "Get Funding Stats": {
            ...
            params: {
                symbol: {
                    ...
                    replace_2dots: !0,
                    type: string,
                    description: "The symbol you want information about. (e.g. fUSD, fBTC, fETH ...)"
                },
                start: {type: "number", description: "Millisecond start time"},
                end: {type: "number", description: "Millisecond end time"},
            ...
            transformOutput: function (e) {
                if (e.length < 1) return e;
                for (var n = ["TIMESTAMP", "PLACEHOLDER", "PLACEHOLDER", "FRR", "AVG_PERIOD", "PLACEHOLDER", "PLACEHOLDER", "FUNDING_AMOUNT", "FUNDING_AMOUNT_USED", "PLACEHOLDER", "PLACEHOLDER", "FUNDING_BELOW_THRESHOLD"], t = 0; t < e[0].length; t++) e[0][t] = n[t];
                return e
            },
        ...
        "Get Candlesticks": {
            ...
            params: {
                ...
                candleInterval: {
                    required: !0,
                    replace_2dots: !0,
                    possible: ["MINUTE_1", "MINUTE_5", "HOUR_1", "DAY_1"],
        ...
        "Get All Symbols": {
            ...
            params: {ts: {type: number, description: "UNIX timestamp to get incremental data"}},
            go_down_1_level: !0,
            transformOutput: function (e) {
                var n = {
                    status: "status",
                ...
                if (e.length < 1) return e;
                for (var t = 0; t < e[0].length; t++) n[e[0][t]] && (e[0][t] = n[e[0][t]]);
                return e
            },
        ...
        "Get Market Symbols Settings": {
            ...
            params: {
                ...
                symbols: {
                    type: string,
                    description: "symbols. NA means all symbols, multiple symbols separated with comma"
                }
            },
            transformOutput: function (e) {
                var n = {
        ...
        "Get Chain Information": {
            ...
            params: {
                ...
                "show-desc": {
                    description: "show desc, 0: no, 1: all, 2: suspend deposit/withdrawal and chain exchange",
                    possible: [0, 1, 2]
                }
            },
            go_down_1_level: !0,
        ...
        "Get Currency and Chains": {
            ...
            params: {
                currency: {
                    type: string,
                    description: "btc, ltc, bch, eth, etc ...(available currencies in Huobi Global)"
                }
            },
            go_down_1_level: !0,
        ...
        "Get Candlesticks": {
            ...
            params: {
                period: {
                    required: !0,
                    description: "The period of each candle",
                    possible: ["1min", "5min", "15min", "30min", "60min", "4hour", "1day", "1mon", "1week", "1year"]
                },
                symbol: {
                    required: !0,
                    description: "A supported trading symbol, e.g. btcusdt, bccbtcn (to retrieve candlesticks for ETP NAV, symbol = ETP trading symbol + suffix 'nav'，for example: btc3lusdtnav)"
                },
        ...
        "Get Latest Aggregated Ticker": {
            ...
            params: {symbol: {required: !0, description: "A supported trading symbol, e.g. btcusdt, bccbtc"}},
            go_down_1_level: !0,
        ...
        "Get Market Depth": {
            ...
            params: {
                depth: {
                    description: "The number of market depth to return on each side",
                    possible: [5, 10, 20],
                    default: 20
                },
                symbol: {required: !0, description: "The trading symbol to query"},
                type: {
                    default: "step0",
                    description: "Market depth aggregation level, details below",
                    possible: ["step0", "step1", "step2", "step3", "step4", "step5"]
                }
            },
            specialHandleFunction: function (e) {
                for (var n = e.tick.asks, t = e.tick.bids, r = [["ask_price", "ask_size", "bids_price", "bids_size"]], i = 0; i < Math.min(n.length, t.length); i++) r.push([n[i][0], n[i][1], t[i][0], t[i][1]]);
                return r
            },
        ...
        "Get Last Trade": {
            url: "/market/trade",
            params: {symbol: {required: !0, description: "The trading symbol to query"}},
            go_down_1_level: !0,
        ...
        "Get Real Time NAV": {
            url: "/market/etp",
            go_down_1_level: !0,
            params: {symbol: {required: !0, description: "ETP trading symbol"}},
        ...
        "Composite Index": {
            ...
            params: {
                symbol: {description: "The composite index symbol.", required: !0},
                count: {
                    type: "number",
                    description: "Number of results to fetch. Must be a positive integer.",
                    default: 100
        ...
        "Summary of Exchange Statistics in USD": {
            ...
            params: {symbol: {description: "Filter by symbol."}},
        ...
        "Previous Quotes in Time Buckets": {
            ...
            params: {
                ...
                startTime: {type: string, description: "Starting date filter for results. (e.g. 2014-12-26 11:00)"},
                endTime: {type: string, description: "Ending date filter for results. (e.g. 2014-12-26 11:00)"},
                binSize: {required: !0, description: "Time interval to bucket by", possible: ["1m", "5m", "1h", "1d"]},
                partial: {
...
}, orders = [], paths = {}, definitions = {}, _i3 = 0, _Object$keys3 = Object.keys(big_api_map); _i3 < _Object$keys3.length; _i3++) {
    var provider = _Object$keys3[_i3];
    orders.push("/" + provider.toLowerCase()), paths["/" + provider.toLowerCase()] = {
        get: {
    ...
    for (var _i4 = 0, _Object$keys4 = Object.keys(big_api_map[provider]); _i4 < _Object$keys4.length; _i4++) {
        var endpoint = _Object$keys4[_i4];
        if (!(endpoint in skip_endpoint)) {
            var path = "/" + provider.toLowerCase() + "/" + endpoint.toLowerCase().replaceAll(" ", "-");
            orders.push(path);
            var parameters = [];
            if (big_api_map[provider][endpoint].params) for (var _i5 = 0, _Object$keys5 = Object.keys(big_api_map[provider][endpoint].params); _i5 < _Object$keys5.length; _i5++) {
                var param = _Object$keys5[_i5];
                big_api_map[provider][endpoint].params[param].append_to_url || parameters.push({
                    in: "query",
                    name: param,
                    ...
                    required: !0 === big_api_map[provider][endpoint].params[param].required,
                    type: "number" === big_api_map[provider][endpoint].params[param].type ? "number" : "string"
                })
            }
            if (paths[path] = {
                get: {
            ...
            }, big_api_map[provider][endpoint].response_attributes) {
                paths[path].get.responses = {
                    200: {
                        description: "successful operation",
                        schema: {type: "array", items: {$ref: "#/definitions/" + provider + endpoint}}
                    }
                };
                for (var this_definition = {
                    type: "object",
                    properties: {}
                }, _i6 = 0, _Object$keys6 = Object.keys(big_api_map[provider][endpoint].response_attributes); _i6 < _Object$keys6.length; _i6++) {
                    var def_key = _Object$keys6[_i6];
