...
var map_metrics = {
  ...
  '3': {display_name: 'Average Monthly Trading Volume (3m)', is_financial_group: '', display_group:['Valuation'], 'type': '1', currency_type: '', default_freq: '', supported_freq:[''], can_be_filter: '', can_be_column: '', plot_type: '', excel: 'avg_trading_volume_3m', default_0: 0},
